...
<body>
	...
	com.study.mybatis.board.dao			(기존 Mgr bybatis에 mgr 연결)
	com.study.mybatis.board.service		(DB실행결과 리턴)
	com.study.mybatis.board.vo			(bean파일들)
	com.study.mybatis.member.
	 ...
	 * 프레임워크의 종류
	  - 영속성(DB) : 데이터에 관련된 CRUD(Create, Read, Update, Delete) 기능들을 보다 편리하게 작업할 수 있도록 제공해주는 프레임워크
